...
/**
 * Note: the deterministic scheduler won't catch the synchronisation error in the
 * class under test.  So, taking control of scheduling makes it easier to test the functionality
 * of the class but we still need to stress test the synchronisation, which we do in the
 * {@link AuctionSearchStressTests}.
 */
@RunWith(JMock.class)
public class AuctionSearch_v3_Tests {
